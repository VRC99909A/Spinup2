 ...
 */
 void opcontrol() {
   ...
   **/
	...
	pros::Task Collector(Collector_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My Task");
	pros::Task Launcher(Launcher_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My Task");
