...
const char *titles[] = {"LeftOne", "LeftMiddle", "shell", "LeftTwo", "RightOne", "RightTwo", "BothOne", "BothTwo", "SkillsAutonOne", "SkillsAutonTwo"};

//define and initialize an array of function pointers for all auton functions
void (*scripts[])() = {&LeftOne, &LeftMiddle, &shell, &LeftTwo, &RightOne, &RightTwo, &BothOne, &BothTwo, &SkillsAutonOne, &SkillsAutonTwo};
